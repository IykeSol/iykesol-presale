    ...
    document.getElementById("buy").innerHTML = `
      <div class="container">
        <div class="section-header">
          ...
          <p>Follow these simple steps to join the future of Solana DeFi on the Sepolia Testnet.</p>
        </div>
        ...
        <div class="buy-grid" style="display:grid; grid-template-columns:repeat(auto-fit, minmax(280px, 1fr)); gap:2rem; margin-top:3rem;">
          <div class="feature-card">
            ...
            <p style="color:var(--muted); font-size:.9rem; line-height:1.6;">Click the <strong>'Connect Wallet'</strong> button in the top right corner. Ensure your wallet (Metamask, TrustWallet, etc.) is set to the <strong>Sepolia Testnet</strong>.</p>
          </div>
          ...
          <div class="feature-card">
            ...
            <h3 style="margin-bottom:1rem; font-size:1.2rem;">2. Get Sepolia ETH</h3>
            <p style="color:var(--muted); font-size:.9rem; line-height:1.6;">You need testnet ETH to participate. Use a public faucet like <a href="https://sepoliafaucet.com/" target="_blank" style="color:var(--primary);">Sepolia Faucet</a> or <a href="https://infura.io/faucet/sepolia" target="_blank" style="color:var(--primary);">Infura Faucet</a> to get free Sepolia ETH.</p>
          </div>
          ...
          <div class="feature-card">
            ...
            <p style="color:var(--muted); font-size:.9rem; line-height:1.6;">On the <strong>Home Page</strong>, enter the amount of ETH you want to spend. The widget will automatically calculate the amount of <strong>$IYKESOL</strong> you will receive.</p>
          </div>
